...
├─────────────────────────────────────────────────────────────────┤
│  EntityListOfInstancesPage (Table View)                                    │
...
**Route:** `/service` → `EntityListOfInstancesPage` → `DataTable`
...
**Route:** `/product` → `EntityListOfInstancesPage` → `DataTable`
...
**Route:** `/quote` → `EntityListOfInstancesPage` → `DataTable`
...
**Route:** `/work_order` → `EntityListOfInstancesPage` → `DataTable`
...
1. **Navigate to Services**
   ```
   Route: /service
   → EntityListOfInstancesPage with entityType='service'
