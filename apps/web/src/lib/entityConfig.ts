 ...
 *
 * ✅ columns: []  // Auto-generated by EntityListOfInstancesTable from API response
 * ✅ fields: []   // Auto-generated by EntityInstanceFormContainer from API response
 *
 ...
 *    - `budget_allocated_amt` → { type: 'currency', label: 'Budget Allocated' }
 *    - `dl__project_stage` → { type: 'badge', label: 'Project Stage' }
 *    - `planned_start_date` → { type: 'date', label: 'Planned Start Date' }
 *
 * 3. **Formatter Service** transforms raw → formatted:
 *    - 50000 → "$50,000.00"
 ...
 * ```
 *
 * That's it! Add column to database → auto-appears in UI with correct:
 * - Formatting (currency, dates, badges, etc.)
 * - Alignment (left/right/center)
 * - Labels (budget_allocated_amt → "Budget Allocated")
 ...
 * ============================================================================
 *
 * ✅ Zero manual configs (was: 1000+ lines of manual field/column definitions)
 * ✅ Convention over configuration (column name determines everything)
 * ✅ Self-healing (add DB column → auto-appears with correct formatting)
 * ✅ DRY principle (one detection rule applies to all entities)
 * ✅ Consistent (all *_amt fields behave identically)
 * ✅ Maintainable (change format once, affects all entities)
 * ✅ Type-safe (TypeScript types preserved throughout)
 *
 * ============================================================================
 */
...
// v17.0.0: ViewMode type moved to useComponentViews.ts (database-driven only)
// View configuration is now EXCLUSIVELY from database entity.component_views
 ...
 *
 * v17.0.0: View configuration removed - now database-driven only
 * Previously: supportedViews, defaultView, kanban, grid, calendar
 * Now: All view config comes from entity.component_views JSONB column
 * See: useComponentViews() hook in apps/web/src/lib/hooks/useComponentViews.ts
 */
...
export const entityConfigs: Record<string, EntityConfig> = {
  ...
  project: {
    ...
    fields: [],
    // v17.0.0: View config now in database entity.component_views
  },
  ...
  task: {
    ...
    // v4.0: Fields auto-generated by EntityInstanceFormContainer via frontEndFormatterService
    fields: [],
    // v17.0.0: Kanban config now in database entity.component_views.KanbanView
  },
...
// v17.0.0: supportsView() and getDefaultView() REMOVED
// View configuration is now database-driven only
// Use useComponentViews() hook instead:
//   import { useComponentViews } from './hooks/useComponentViews';
//   const { supportedViews, defaultView } = useComponentViews(entityCode);
