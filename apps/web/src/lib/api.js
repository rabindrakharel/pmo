...
export const authApi = {
    ...
    async customerSignin(credentials) {
    ...
    async configureCustomerEntities(entities) {
...
export const formApi = {
    async list(params) {
        ...
        const offset = ((params?.page ?? 1) - 1) * limit;
        const query = { limit, offset };
        if (params?.showAllVersions != null)
            query.showAllVersions = params.showAllVersions;
...
export const artifactApi = {
    async list(params) {
        ...
        if (params?.project_stage)
            query.project_stage = params.project_stage;
...
export const entityInstanceApi = {
     ...
     */
    async getEntityInstances(entityCode, params) {
     ...
     * @returns { id, name }
     */
    async getEntityInstance(entityCode, id) {
     ...
     */
    async getEntityInstancesBulk(entityCode, ids) {
     ...
     * ```
     */
    async getChildEntities(parentType, parentId, params) {
 ...
 */
export async function fetchEntityData(entityCode, entityId) {
    try {
        const api = APIFactory.getAPI(entityCode);
