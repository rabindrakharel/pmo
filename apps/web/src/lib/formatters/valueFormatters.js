...
import { formatLocalizedDate, formatRelativeTime as formatRelativeTimeUtil } from '../utils/dateUtils';
/**
 * Convert color code from database to Tailwind badge classes
 */
export function colorCodeToTailwindClass(colorCode) {
    if (!colorCode)
 ...
 */
export function formatCurrency(value, metadata) {
 ...
 */
export function formatBadge(value, metadata) {
    if (value === null || value === undefined || value === '') {
        return { display: '—' };
    }
 ...
 */
export function formatDate(value, metadata) {
    if (value === null || value === undefined || value === '') {
        return { display: '—' };
    }
    const locale = metadata?.locale || 'en-CA';
 ...
 */
export function formatRelativeTime(value, _metadata) {
    if (value === null || value === undefined || value === '') {
        return { display: '—' };
    }
 ...
 */
export function formatBoolean(value, _metadata) {
 ...
 */
export function formatPercentage(value, metadata) {
    if (value === null || value === undefined || value === '') {
        return { display: '—' };
    }
    const num = typeof value === 'number' ? value : parseFloat(value);
...
export function formatReference(value, metadata) {
    if (value === null || value === undefined || value === '') {
        return { display: '—' };
    }
