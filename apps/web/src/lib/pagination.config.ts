...
export const PAGINATION_CONFIG = {
  ...
  /** API fetch limit (v9.4.1: 1000 per API page) */
  API_FETCH_LIMIT: 1000,

  /** Client render limit (v9.4.1: 500 rendered at a time via client pagination) */
  CLIENT_RENDER_LIMIT: 500,

  /** Default limit for bulk data loading */
  DEFAULT_LIMIT: 1000,

  /** Maximum allowed limit per request (v9.4.1: 1000 for sliding window) */
  MAX_LIMIT: 1000,
