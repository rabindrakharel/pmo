...
import { Settings, Search, ChevronDown, X, Wrench } from 'lucide-react';
...
export function SettingsPage() {
  const [selectedSettings, setSelectedSettings] = useState<SettingTab[]>(['projectStatus']);
  ...
  const entityGroups: EntityGroup[] = [
    {
      ...
      settings: [
        { id: 'projectStatus', label: 'Project Status', icon: ENTITY_ICONS.projectStatus, entity: 'project' },
    ...
    },
    {
      ...
      settings: [
        { id: 'taskStatus', label: 'Task Status', icon: ENTITY_ICONS.taskStatus, entity: 'task' },
    ...
    },
    {
      ...
      settings: [
        { id: 'hrLevel', label: 'HR Level', icon: ENTITY_ICONS.hrLevel, entity: 'employee' },
    ...
    },
    {
      ...
      settings: [
        { id: 'clientLevel', label: 'Client Level', icon: ENTITY_ICONS.clientLevel, entity: 'client' },
          ...
          <div className="px-4 py-5 sm:p-6">
            ...
            <div className="flex items-center mb-6">
              ...
              <div className="ml-4 flex-1">
                <h1 className="text-sm font-normal text-gray-900">System Settings</h1>
            ...
            {selectedSettings.length === 0 ? (
              <div className="text-center py-12 text-gray-500">
                ...
                <p className="text-sm font-normal">No settings selected</p>
                <p className="text-sm">Use the dropdown above to select settings to manage</p>
              </div>
            ) : (
              <div className="space-y-8">
                {selectedSettings.map((settingId) => {
                  const setting = allSettings.find(s => s.id === settingId);
                  const SettingIcon = setting?.icon || Settings;
