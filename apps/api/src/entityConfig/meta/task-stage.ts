...
export const taskStageConfig: EntityPageConfig = {
  ...
  api: {
    baseEndpoint: '/api/v1/meta/taskStage',
    endpoints: {
      list: 'GET /api/v1/meta?category=taskStage',
      get: 'GET /api/v1/meta/taskStage/:id',
      create: 'POST /api/v1/meta/taskStage',
      update: 'PUT /api/v1/meta/taskStage/:id',
      delete: 'DELETE /api/v1/meta/taskStage/:id',
    },
  },
