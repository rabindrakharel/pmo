 ...
 *   3. Edit/view in context: GET /api/v1/project?parent_entity_code=business&parent_entity_instance_id={id}
 *
 * Benefits:
 ...
 *   1. User requests POST /api/v1/project?parent_entity_code=business&parent_entity_instance_id={id}
...
export async function projectRoutes(fastify: FastifyInstance) {
  ...
  fastify.get('/api/v1/project/:id', {
    ...
    try {
      ...
      const response = await generateEntityResponse(ENTITY_CODE, [project], {
        components: requestedComponents,
        total: 1,
        limit: 1,
        offset: 0
