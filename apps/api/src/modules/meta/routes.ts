...
const MetaItemSchema = Type.Object({
  ...
  level_id: Type.Optional(Type.Union([Type.Number(), Type.Null()])),
  sort_id: Type.Optional(Type.Union([Type.Number(), Type.Null()])),
  sort_order: Type.Optional(Type.Union([Type.Number(), Type.Null()])),
  country_code: Type.Optional(Type.Union([Type.String(), Type.Null()])),
  salary_band_min: Type.Optional(Type.Union([Type.Number(), Type.Null()])),
  salary_band_max: Type.Optional(Type.Union([Type.Number(), Type.Null()])),
  is_management_level: Type.Optional(Type.Union([Type.Boolean(), Type.Null()])),
  is_executive_level: Type.Optional(Type.Union([Type.Boolean(), Type.Null()])),
  duration_weeks: Type.Optional(Type.Union([Type.Number(), Type.Null()])),
  color: Type.Optional(Type.Union([Type.String(), Type.Null()])),
  workflow_sequence: Type.Optional(Type.Union([Type.Number(), Type.Null()])),
  is_terminal_state: Type.Optional(Type.Union([Type.Boolean(), Type.Null()])),
  is_success_state: Type.Optional(Type.Union([Type.Boolean(), Type.Null()])),
  attr: Type.Optional(Type.Object({})),
  from_ts: Type.Optional(Type.Union([Type.String(), Type.Null()])),
