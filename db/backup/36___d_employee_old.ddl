...
-- CEO/President
('James Miller', 'Chief Executive Officer and Founder of Huron Home Services - Leading company vision and strategic growth', '1250 South Service Rd, Mississauga, ON L5E 1V4', 'james.miller@huronhome.ca', '$2b$10$4A3KzsNJOidrtvYp6v0qg.GAeSF7B13llqsBK8e9z4UBMCtVFdO5y', '+1-905-555-1001', '+1-905-555-1002', '{"name": "Patricia Miller", "relationship": "spouse", "phone": "+1-905-555-1003"}'::jsonb,
...
-- Operations Director
('Sarah Chen', 'Director of Operations - Overseeing daily operations across all service divisions and managing field teams', '1250 South Service Rd, Mississauga, ON L5E 1V4', 'sarah.chen@huronhome.ca', '$2b$10$4A3KzsNJOidrtvYp6v0qg.GAeSF7B13llqsBK8e9z4UBMCtVFdO5y', '+1-905-555-2001', '+1-905-555-2002', '{"name": "Michael Chen", "relationship": "brother", "phone": "+1-905-555-2003"}'::jsonb,
...
-- Manager
('Robert Thompson', 'Landscaping Department Manager - Leading comprehensive landscaping services and seasonal operations', '1250 South Service Rd, Mississauga, ON L5E 1V4', 'robert.thompson@huronhome.ca', '$2b$10$4A3KzsNJOidrtvYp6v0qg.GAeSF7B13llqsBK8e9z4UBMCtVFdO5y', '+1-905-555-3001', '+1-905-555-3002', '{"name": "Linda Thompson", "relationship": "spouse", "phone": "+1-905-555-3003"}'::jsonb,
...
('Maria Santos', 'Senior Landscaping Team Lead - Supervising daily landscaping operations and training junior staff', '45 Mapleview Dr, Mississauga, ON L5A 2K8', 'maria.santos@huronhome.ca', '$2b$10$4A3KzsNJOidrtvYp6v0qg.GAeSF7B13llqsBK8e9z4UBMCtVFdO5y', '+1-905-555-3101', '+1-905-555-3102', '{"name": "Carlos Santos", "relationship": "spouse", "phone": "+1-905-555-3103"}'::jsonb,
...
('David Kumar', 'Experienced Landscaper - Specializing in garden design, lawn care, and seasonal maintenance services', '78 Creditview Rd, Mississauga, ON L5M 4Z5', 'david.kumar@huronhome.ca', '$2b$10$4A3KzsNJOidrtvYp6v0qg.GAeSF7B13llqsBK8e9z4UBMCtVFdO5y', '+1-905-555-3201', '+1-905-555-3202', '{"name": "Priya Kumar", "relationship": "spouse", "phone": "+1-905-555-3203"}'::jsonb,
...
('Jennifer Walsh', 'Part-time Seasonal Landscaper - Supporting peak season landscaping operations and maintenance', '22 Erin Mills Pkwy, Mississauga, ON L5M 4Z2', 'jennifer.walsh@huronhome.ca', '$2b$10$4A3KzsNJOidrtvYp6v0qg.GAeSF7B13llqsBK8e9z4UBMCtVFdO5y', '+1-905-555-3301', '+1-905-555-3302', '{"name": "Brian Walsh", "relationship": "brother", "phone": "+1-905-555-3303"}'::jsonb,
...
('Green Earth Landscaping Inc.', 'Independent Landscaping Contractor - Specialized services for large residential and commercial projects', 'Various client locations', 'contact@greenearth.ca', '$2b$10$4A3KzsNJOidrtvYp6v0qg.GAeSF7B13llqsBK8e9z4UBMCtVFdO5y', '+1-905-555-3401', '+1-905-555-3402', '{"name": "Tom Green", "relationship": "owner", "phone": "+1-905-555-3403"}'::jsonb,
...
-- =========== PLUMBING DEPARTMENT ===========
-- Manager
('Michael O''Brien', 'Master Plumber and Department Manager - Leading all plumbing services including emergency response', '1250 South Service Rd, Mississauga, ON L5E 1V4', 'michael.obrien@huronhome.ca', '$2b$10$4A3KzsNJOidrtvYp6v0qg.GAeSF7B13llqsBK8e9z4UBMCtVFdO5y', '+1-905-555-4001', '+1-905-555-4002', '{"name": "Catherine O''Brien", "relationship": "spouse", "phone": "+1-905-555-4003"}'::jsonb,
...
('Andrew Peterson', 'Licensed Journeyman Plumber - Residential and commercial plumbing installations and repairs', '156 Burnhamthorpe Rd W, Mississauga, ON L5B 3C2', 'andrew.peterson@huronhome.ca', '$2b$10$4A3KzsNJOidrtvYp6v0qg.GAeSF7B13llqsBK8e9z4UBMCtVFdO5y', '+1-905-555-4101', '+1-905-555-4102', '{"name": "Sarah Peterson", "relationship": "spouse", "phone": "+1-905-555-4103"}'::jsonb,
...
('Kevin Patel', 'Third-year Plumbing Apprentice - Learning advanced plumbing techniques while supporting senior plumbers', '89 Hurontario St, Mississauga, ON L5G 3H5', 'kevin.patel@huronhome.ca', '$2b$10$4A3KzsNJOidrtvYp6v0qg.GAeSF7B13llqsBK8e9z4UBMCtVFdO5y', '+1-905-555-4201', '+1-905-555-4202', '{"name": "Raj Patel", "relationship": "father", "phone": "+1-905-555-4203"}'::jsonb,
...
-- Contractor Plumber
('Emergency Plumbing Solutions Ltd.', 'Licensed Emergency Plumbing Contractor - 24/7 emergency plumbing services and complex installations', 'Various emergency locations', 'dispatch@emergencyplumb.ca', '$2b$10$4A3KzsNJOidrtvYp6v0qg.GAeSF7B13llqsBK8e9z4UBMCtVFdO5y', '+1-905-555-4301', '+1-905-555-4302', '{"name": "Emergency Dispatch", "phone": "+1-905-555-4303"}'::jsonb,
...
-- =========== HVAC DEPARTMENT ===========
-- HVAC Technician
('Lisa Rodriguez', 'Licensed HVAC Technician - Installation and maintenance of heating, ventilation, and air conditioning systems', '1250 South Service Rd, Mississauga, ON L5E 1V4', 'lisa.rodriguez@huronhome.ca', '$2b$10$4A3KzsNJOidrtvYp6v0qg.GAeSF7B13llqsBK8e9z4UBMCtVFdO5y', '+1-905-555-5001', '+1-905-555-5002', '{"name": "Carlos Rodriguez", "relationship": "spouse", "phone": "+1-905-555-5003"}'::jsonb,
...
('Emma Foster', 'Customer Service Representative - Handling customer inquiries, booking appointments, and service coordination', '1250 South Service Rd, Mississauga, ON L5E 1V4', 'emma.foster@huronhome.ca', '$2b$10$4A3KzsNJOidrtvYp6v0qg.GAeSF7B13llqsBK8e9z4UBMCtVFdO5y', '+1-905-555-7001', '+1-905-555-7002', '{"name": "Mark Foster", "relationship": "spouse", "phone": "+1-905-555-7003"}'::jsonb,
...
('Frank Kowalski', 'Seasonal Snow Removal Equipment Operator - Operating plows and salt spreaders during winter months', '15 Matheson Blvd W, Mississauga, ON L5R 3L8', 'frank.kowalski@huronhome.ca', '$2b$10$4A3KzsNJOidrtvYp6v0qg.GAeSF7B13llqsBK8e9z4UBMCtVFdO5y', '+1-905-555-8001', '+1-905-555-8002', '{"name": "Anna Kowalski", "relationship": "spouse", "phone": "+1-905-555-8003"}'::jsonb,
...
('Ahmed Hassan', 'Certified Solar Installation Technician - Installation and maintenance of residential solar panel systems', '467 Talbot St, London, ON N6A 2S5', 'ahmed.hassan@huronhome.ca', '$2b$10$4A3KzsNJOidrtvYp6v0qg.GAeSF7B13llqsBK8e9z4UBMCtVFdO5y', '+1-519-555-9001', '+1-519-555-9002', '{"name": "Fatima Hassan", "relationship": "spouse", "phone": "+1-519-555-9003"}'::jsonb,
