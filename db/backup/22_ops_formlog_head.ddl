...
CREATE TABLE app.ops_formlog_head (
  ...
  business_id uuid REFERENCES app.d_scope_org(id),
  ...
  CONSTRAINT valid_scoping CHECK (
    project_specific OR task_specific OR location_specific OR 
    business_specific OR hr_specific OR worksite_specific OR 
...
INSERT INTO app.ops_formlog_head (
  ...
  business_specific, business_id, business_permission,
