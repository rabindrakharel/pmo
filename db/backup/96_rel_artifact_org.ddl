-- ============================================================================
-- ARTIFACT-ORGANIZATION RELATIONSHIP TABLE
-- ============================================================================
...
--
-- Purpose:
--   Many-to-many relationship between artifacts and organizational units,
--   enabling artifacts to be associated with multiple organizational levels
--   from corporate-wide policies to department-specific procedures and
--   team-level operational documents.
--
-- Integration:
--   - Links d_artifact to d_scope_org for organizational ownership
...
CREATE TABLE app.rel_artifact_org (
  ...
  -- Unique constraint
  UNIQUE(artifact_id, org_id, from_ts) DEFERRABLE INITIALLY DEFERRED
);
...
-- Artifact-Organization Relationships for Huron Home Services
...
INSERT INTO app.rel_artifact_org (
  artifact_id, org_id, scope_level, ownership_type, access_level,
