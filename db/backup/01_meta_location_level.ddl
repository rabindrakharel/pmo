-- ============================================================================
-- LOCATION HIERARCHY META LEVELS 
-- ============================================================================
...
--
-- Purpose:
--   Meta configuration defining location hierarchy levels following Canadian
...
--
-- Integration:
--   - Referenced by d_scope_location table via level_id
--   - Supports geographic reporting and jurisdictional compliance
--   - Enables location-based resource allocation and service delivery
...
CREATE TABLE app.meta_location_level (
...
-- Canadian Location Hierarchy Levels (Corp-Region starts at level 0)
INSERT INTO app.meta_location_level (level_id, level_name, slug, is_root, is_leaf) VALUES
