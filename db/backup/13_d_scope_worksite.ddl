...
--
-- Integration:
--   - References d_scope_location for geographic placement
...
WITH mississauga_addr AS (
  SELECT id FROM app.d_scope_location 
  WHERE name = '1250 South Service Rd, Mississauga, ON L5E 1V4'
)
INSERT INTO app.d_scope_worksite (
  name, "descr", worksite_code, worksite_type, location_id, addr, postal_code, 
...
WITH toronto AS (SELECT id FROM app.d_scope_location WHERE name = 'Toronto')
INSERT INTO app.d_scope_worksite (
  name, "descr", worksite_code, worksite_type, location_id, addr, postal_code,
  latitude, longitude, capacity_workers, equipment_storage, vehicle_parking,
  security_required, indoor_space_sqft, outdoor_space_sqft, office_space,
...
('Winter Ops - Equipment Staging',
 ...
 'HHS-WINTER-STG',
 'seasonal',
 (SELECT id FROM app.d_scope_location WHERE name = 'Hamilton CMA'),
...
('Solar Install - 1847 Sheridan Park Dr',
 ...
 'HHS-SOL-1847',
 'project',
 (SELECT id FROM app.d_scope_location WHERE name = 'Oakville'),
...
('Landscaping - Square One Plaza',
 ...
 'HHS-LAND-SQ1',
 'project',
 (SELECT id FROM app.d_scope_location WHERE name = 'City Centre'),
...
('Equipment Storage - Meadowvale',
 ...
 'HHS-EQUIP-MV',
 'storage',
 (SELECT id FROM app.d_scope_location WHERE name = 'Meadowvale'),
