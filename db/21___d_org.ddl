...
CREATE TABLE app.d_org (
  ...
  parent_id uuid REFERENCES app.d_org(id) ON DELETE SET NULL,
...
INSERT INTO app.d_org (name, "descr", code, level_id, level_name, parent_id, is_leaf_level, country_code, time_zone, service_area, regulatory_jurisdiction, tags, attr) VALUES
...
WITH corp_region AS (SELECT id FROM app.d_org WHERE name = 'North America Central')
INSERT INTO app.d_org (name, "descr", code, level_id, level_name, parent_id, is_leaf_level, country_code, time_zone, service_area, regulatory_jurisdiction, tags, attr)
SELECT 
  'Canada',
...
WITH canada AS (SELECT id FROM app.d_org WHERE name = 'Canada')
INSERT INTO app.d_org (name, "descr", code, level_id, level_name, parent_id, is_leaf_level, country_code, province_code, time_zone, service_area, regulatory_jurisdiction, tags, attr)
SELECT 
  'Ontario',
...
WITH ontario AS (SELECT id FROM app.d_org WHERE name = 'Ontario')
INSERT INTO app.d_org (name, "descr", code, level_id, level_name, parent_id, is_leaf_level, country_code, province_code, time_zone, service_area, regulatory_jurisdiction, stats_can_code, tags, attr)
SELECT 
...
WITH gta AS (SELECT id FROM app.d_org WHERE name = 'Greater Toronto Area')
INSERT INTO app.d_org (name, "descr", code, level_id, level_name, parent_id, is_leaf_level, country_code, province_code, time_zone, service_area, regulatory_jurisdiction, stats_can_code, tags, attr)
SELECT 
  'Toronto CMA',
...
-- City Level (Level 5)
WITH toronto_cma AS (SELECT id FROM app.d_org WHERE name = 'Toronto CMA')
INSERT INTO app.d_org (name, "descr", code, level_id, level_name, parent_id, is_leaf_level, country_code, province_code, postal_code, time_zone, service_area, regulatory_jurisdiction, municipal_code, latitude, longitude, tags, attr)
SELECT 
  'Mississauga',
...
WITH mississauga AS (SELECT id FROM app.d_org WHERE name = 'Mississauga')
INSERT INTO app.d_org (name, "descr", code, level_id, level_name, parent_id, is_leaf_level, country_code, province_code, postal_code, time_zone, service_area, regulatory_jurisdiction, latitude, longitude, tags, attr)
SELECT 
  'City Centre',
...
WITH city_centre AS (SELECT id FROM app.d_org WHERE name = 'City Centre')
INSERT INTO app.d_org (name, "descr", code, level_id, level_name, parent_id, is_leaf_level, country_code, province_code, postal_code, time_zone, service_area, regulatory_jurisdiction, latitude, longitude, tags, attr)
SELECT 
