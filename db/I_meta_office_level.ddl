-- =====================================================
-- META OFFICE LEVEL TABLE
-- Office hierarchy levels: Office, District, Region, Corporate
-- =====================================================

CREATE TABLE app.meta_office_level (
...
COMMENT ON TABLE app.meta_office_level IS 'Office hierarchy levels: Office → District → Region → Corporate';