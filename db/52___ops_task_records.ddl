...
VALUES
  ...
  ((SELECT id FROM app.ops_task_head WHERE task_number = 'TASK-FALL-001'), 
  ...
  ((SELECT id FROM app.ops_task_head WHERE task_number = 'TASK-FALL-002'),
  ...
  ((SELECT id FROM app.ops_task_head WHERE task_number = 'TASK-FALL-003'),
  ...
  ((SELECT id FROM app.ops_task_head WHERE task_number = 'TASK-WINTER-001'),
  ...
  ((SELECT id FROM app.ops_task_head WHERE task_number = 'TASK-WINTER-002'),
  ...
  ((SELECT id FROM app.ops_task_head WHERE task_number = 'TASK-HVAC-001'),
  ...
  ((SELECT id FROM app.ops_task_head WHERE task_number = 'TASK-HVAC-002'),
  ...
  ((SELECT id FROM app.ops_task_head WHERE task_number = 'TASK-SOLAR-001'),
