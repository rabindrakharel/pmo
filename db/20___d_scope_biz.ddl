...
INSERT INTO app.d_scope_biz (name, "descr", org_code, level_id, level_name, parent_id, is_leaf_level, budget_allocated, cost_center_code, biz_unit_type, profit_center, external_facing, tags, attr) VALUES
...
WITH corp AS (SELECT id FROM app.d_scope_biz WHERE name = 'Huron Home Services')
INSERT INTO app.d_scope_biz (name, "descr", org_code, level_id, level_name, parent_id, is_leaf_level, budget_allocated, cost_center_code, biz_unit_type, profit_center, external_facing, tags, attr)
SELECT 
...
WITH bod AS (SELECT id FROM app.d_scope_biz WHERE name = 'Biz Operations Division')
INSERT INTO app.d_scope_biz (name, "descr", org_code, level_id, level_name, parent_id, is_leaf_level, budget_allocated, cost_center_code, biz_unit_type, profit_center, external_facing, tags, attr)
SELECT 
...
WITH land_dept AS (SELECT id FROM app.d_scope_biz WHERE name = 'Landscaping Department')
INSERT INTO app.d_scope_biz (name, "descr", org_code, level_id, level_name, parent_id, is_leaf_level, budget_allocated, cost_center_code, biz_unit_type, profit_center, external_facing, tags, attr)
SELECT 
...
WITH res_team AS (SELECT id FROM app.d_scope_biz WHERE name = 'Residential Landscaping Team')
INSERT INTO app.d_scope_biz (name, "descr", org_code, level_id, level_name, parent_id, is_leaf_level, budget_allocated, cost_center_code, biz_unit_type, profit_center, external_facing, tags, attr)
SELECT 
  'Garden Design Squad',
...
WITH design_squad AS (SELECT id FROM app.d_scope_biz WHERE name = 'Garden Design Squad')
INSERT INTO app.d_scope_biz (name, "descr", org_code, level_id, level_name, parent_id, is_leaf_level, budget_allocated, cost_center_code, biz_unit_type, profit_center, external_facing, tags, attr)
SELECT 
