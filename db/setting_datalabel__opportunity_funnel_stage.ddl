-- ============================================================================
-- VII. OPPORTUNITY FUNNEL STAGE SETTINGS
-- ============================================================================
...
--
-- Integration Points:
--   - d_client table uses opportunity_funnel_stage_id to track client status
...
--   the 'funnel' and 'stage' patterns in the field key ('opportunity_funnel_stage_name').
...
--
--   Integration:
--   - API endpoint: GET /api/v1/setting?category=opportunity_funnel_stage
...
CREATE TABLE app.setting_datalabel_opportunity_funnel_stage (
...
-- Index for opportunity funnel stage
CREATE INDEX idx_opportunity_funnel_stage_parent ON app.setting_datalabel_opportunity_funnel_stage(parent_id);
...
-- Colors follow the standard sequential state palette

INSERT INTO app.setting_datalabel_opportunity_funnel_stage (stage_id, stage_name, stage_descr, sort_order, parent_id, active_flag) VALUES
...
COMMENT ON TABLE app.setting_datalabel_opportunity_funnel_stage IS 'Sequential state table for sales opportunity funnel stages with graph-like flow relationships';
COMMENT ON COLUMN app.setting_datalabel_opportunity_funnel_stage.parent_id IS 'Most common preceding stage in the funnel flow. NULL for initial or independent states.';
