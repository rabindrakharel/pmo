...
DROP TABLE IF EXISTS app.f_order CASCADE;
...
CREATE TRIGGER f_order_calculate_extended BEFORE INSERT OR UPDATE ON app.f_order
...
('ORD-2025-00007', 1, 'standard', '2025-01-28', '2025-01-28 10:15:00',
 ...
 (SELECT id FROM app.d_product WHERE code = 'HVAC-003'), 'HVAC-003', 'MERV 13 Filter 16x20x1', 'HVAC',
 'James Miller', 50, 'each',
 19.99, 17.99, 12.50, 10.01,
 13.00, 'delivered', 'fulfilled', 'paid');

-- Update timestamps
UPDATE app.f_order SET updated_at = NOW();

COMMENT ON TABLE app.f_order IS 'Customer order fact table with grain at order line item level';
