...
-- • name: varchar(200) - descriptive name (e.g., "James Miller - HVAC Consultation")
-- • descr: text - additional details
-- • person_entity_type: varchar(50) ('employee', 'client', 'customer') - type of person
...
-- • from_ts: timestamptz NOT NULL - when this person's commitment starts
-- • to_ts: timestamptz NOT NULL - when this person's commitment ends
-- • timezone: varchar(50) DEFAULT 'America/Toronto' - timezone for the time commitment
--
