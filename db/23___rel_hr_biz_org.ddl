...
--   - Links d_scope_hr to d_scope_org for geographic assignment
...
CREATE TABLE app.rel_hr_org_location (
  ...
  UNIQUE(hr_id, org_id, org_id, from_ts) DEFERRABLE INITIALLY DEFERRED
);
...
locations AS (
  SELECT 
    (SELECT id FROM app.d_scope_org WHERE name = '1250 South Service Rd, Mississauga, ON L5E 1V4') AS headquarters_id,
...
INSERT INTO app.rel_hr_org_location (
  hr_id, org_id, org_id, assignment_type, assignment_percentage,
