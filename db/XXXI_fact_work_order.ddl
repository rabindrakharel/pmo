...
-- • labor_hours: numeric(10,2) (actual labor hours)
-- • total_cost_amt: decimal(15,2) (total work order cost)
-- • customer_signature_flag: boolean (customer signed off on completion)
--
