...
CREATE TABLE app.setting_business_level (
...
INSERT INTO app.setting_business_level (level_id, level_name, level_descr, sort_order) VALUES
...
COMMENT ON TABLE app.setting_business_level IS 'Business hierarchy levels: Department → Division → Corporate';