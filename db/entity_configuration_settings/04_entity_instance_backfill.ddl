...
-- ============================================================================
-- This file backfills entity_instance_registry with all existing entity instances
...
--
-- Import Order: This file MUST run AFTER 31_entity_instance_registry.ddl
-- ============================================================================

-- Register all quotes
INSERT INTO app.entity_instance_registry (entity_type, entity_id, entity_name, entity_code)
