...
--
-- SEMANTICS:
-- Seed data for entity_rbac table with default permissions for:
...
--   - 06_entity_rbac.ddl (line 234) - Creates RBAC table structure
...
INSERT INTO app.entity_rbac (person_entity_name, person_entity_id, entity_name, entity_id, permission, granted_by_employee_id, active_flag)
SELECT
  'employee',
