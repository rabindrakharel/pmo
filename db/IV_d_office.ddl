...
-- • code: varchar(50) UNIQUE ('LON-OFF-001')
-- • name: varchar(200) NOT NULL ('London Service Office')
-- • address_line1, city, province, postal_code: varchar (full address)
...
-- KEY FIELDS:
-- • id: uuid PRIMARY KEY
-- • code: varchar(50) UNIQUE NOT NULL ('OFF-HIE-CORP-HQ', 'OFF-HIE-ON-REG')
-- • name: varchar(200) NOT NULL ('Corporate Headquarters', 'Ontario Region')
-- • parent_id: uuid (self-referential, NULL for Corporate level)
-- • dl__office_hierarchy_level: text (Corporate, Region, District, Office)
--
-- RELATIONSHIPS:
