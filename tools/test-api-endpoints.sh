...
make_request "GET" "/api/v1/employee?limit=3" "200" "List employees (James Miller has CEO access)"
make_request "GET" "/api/v1/employee/016546e1-233d-4358-a5b6-5e6a1f7f4c6b" "200" "Get James Miller employee record"
echo ""
...
echo "🏗️ Entity Management:"
make_request "GET" "/api/v1/entity/hr?limit=3" "200" "List HR entities (James Miller has CEO access)"
make_request "GET" "/api/v1/entity/org?limit=3" "200" "List organization entities (James Miller has CEO access)"
make_request "GET" "/api/v1/entity/biz?limit=3" "200" "List business entities (James Miller has CEO access)"
echo ""
