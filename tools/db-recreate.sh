#!/bin/bash
# Database Recreate Tool - Drops and recreates schema with curated data in one step
...
echo -e "${BLUE}🔄 PMO Database Recreate Tool${NC}"
echo "======================================="
...
echo -e "${YELLOW}Step 1/2: Dropping existing schema...${NC}"
...
echo ""
echo -e "${YELLOW}Step 2/2: Importing schema and curated data...${NC}"
